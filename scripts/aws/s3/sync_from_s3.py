...
USAGE:
    ...
    # Sync default paths (assets, css, phaserjs_editor_scripts_base, src, index.html, favicon.ico)
...
from aws_config import BUCKET, S3_PREFIX, DEFAULT_PATHS
...
def parse_project_path(project_root, project_path, bucket_override=None, prefix_override=None):
    ...
    Paths are synced from: llg-games/games/breaker/{path}/
